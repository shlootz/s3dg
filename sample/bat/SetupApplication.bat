...
:: Android packaging
set AND_CERT_NAME="Santa Gun"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\NewProject.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\iOS\SantaDistribution.p12
set IOS_DEV_CERT_FILE=cert\iOS\SantaGun.p12
set IOS_DEV_CERT_PASS=mylifeforaiur1
set IOS_PROVISION=cert\iOS\Santa_Gun_Provisioning_Profile.mobileprovision
...
set APP_ID=air.com.Santa

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SantaGun
